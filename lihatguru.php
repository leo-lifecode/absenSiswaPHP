                    ...
                    <?php
                      ...
                      ?>
                        <tr>
                          <td><?= $i++; ?></td>
                          <td>
                            <img src="uploads/<?= $foto; ?>" width="50" class="img-profile rounded-circle" />
                          </td>
                          <td><?= $nidn; ?></td>
                          <td><?= $nama; ?></td>
                          <td><?= $jk; ?></td>
                          <td>
                            <a href="deleteguru.php?id=<?= $data["NIDN"]; ?>" class="btn btn-danger btn-icon-split">
                              <span class="icon text-white-50">
                                <i class="fas fa-user"></i>
                              </span>
                              <span class="text">Delete</span>
                            </a>
                            <a href="showguru.php?id=<?= $data["NIDN"]; ?>" class="btn btn-success btn-icon-split">
                              <span class="icon text-white-50">
                                <i class="fas fa-user"></i>
                              </span>
                              <span class="text">Show</span>
                            </a>
                            <a href="editguru.php?edittabel=<?= $data["NIDN"]; ?>" class="btn btn-warning btn-icon-split">
                              <span class="icon text-white-50">
                                <i class="fas fa-user"></i>
                              </span>
