...
if (isset($_GET['edittabel'])) {
    ...
    $query_edit = "SELECT * FROM guru WHERE NIDN = ?";
    ...
    if ($edit_data) {
        $name = $edit_data['NAME'];
        $jk = $edit_data['JK'];
        $tanggal = $edit_data['TGL_LAHIR'];
        $email = $edit_data['EMAIL'];
        $no_hp = $edit_data['NO_HP'];
        $foto = $edit_data['FOTO'];
        $agama = $edit_data['AGAMA'];
        $alamat = $edit_data['ALAMAT'];
...
if (isset($_POST['update'])) {
    ...
    $query_update = "UPDATE guru
                     SET NAME = '$name', JK = '$jk', TGL_LAHIR = '$tanggal', EMAIL = '$email', PASSWORD = '$password', NO_HP = '$no_hp', FOTO = '$foto', AGAMA = '$agama', ALAMAT = '$alamat'
                     WHERE NIDN = $edit_id";

    if (mysqli_query($koneksi, $query_update)) {
        echo "<script>alert('Data berhasil diperbarui!');</script>";
        echo "<script>window.location.href='lihatguru.php';</script>";
    } else {
                                ...
                                <form action="" method="post">
                                    <div class="form-group">
                                        <table class="table table-borderless">
                                            ...
                                            <input type="hidden" class="form-control" name="password" autocomplete="off" value="<?= $password; ?>">
                                            <input type="hidden" class="form-control" name="foto" autocomplete="off" value="<?= $foto; ?>">
                                                <tr>
                                                    <td>Nama Guru</td>
                                                ...
                                                <tr>
                                                    <td>Email</td>
                                                    <td><input type="text" class="form-control" name="email" autocomplete="off" value="<?= $email; ?>"></td>
                                                </tr>


                                                <tr>
                                                    <td>Tanggal</td>
                                                    <td><input type="text" class="form-control" value="<?= $tanggal ?>" name="tanggal"></td>
                                                </tr>

                                                <tr>
                                                    <td>Alamat</td>
                                                    <td><input type="text" class="form-control" value="<?= $alamat ?>" name="alamat"></td>
                                                </tr>

                                                <tr>
                                                    <td>No Telepon</td>
                                                    <td><input type="text" class="form-control" value="<?= $no_hp ?>" name="no_hp"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td><button type="submit" name="update" class="btn btn-primary">Perbarui Guru</button></td>
                                                    <td>
                                                        <a href="lihatguru.php" class="btn btn-warning">
                                                           Cancel
                                                        </a>
                                                    </td>
                                                </tr>
